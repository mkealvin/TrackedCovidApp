...
class DataSource {
  static String quote = "Kita Perlu Melawan Virus ini";
  ...
  static List questionAnswers = [
    ...
    {
      "question": "Bisakah virus penyebab COVID-19 ditularkan melalui udara?",
      "answer":
    ...
    },
    {
      ...
      "answer":
          "Risikonya tergantung di mana Anda berada - dan lebih khusus lagi, apakah ada wabah COVID-19 yang sedang berlangsung di sana.\nBagi sebagian besar orang di sebagian besar lokasi, risiko tertular COVID-19 masih rendah. Namun, sekarang ada tempat di seluruh dunia (kota atau daerah) di mana penyakit ini menyebar. Bagi orang-orang yang tinggal di, atau berkunjung, daerah-daerah tersebut risiko tertular COVID-19 lebih tinggi. Pemerintah dan otoritas kesehatan mengambil tindakan tegas setiap kali kasus baru COVID-19 diidentifikasi. Pastikan untuk mematuhi pembatasan lokal tentang perjalanan, pergerakan, atau pertemuan besar. Bekerja sama dalam upaya pengendalian penyakit akan mengurangi risiko Anda terkena atau menyebarkan COVID-19.\nWabah COVID-19 dapat dibendung dan penularan dapat dihentikan, seperti yang telah ditunjukkan di China dan beberapa negara lain. Sayangnya, wabah baru dapat muncul dengan cepat. Penting untuk menyadari situasi di mana Anda berada atau berniat untuk pergi. WHO menerbitkan pembaruan harian tentang situasi COVID-19 di seluruh dunia."
    },
    {
      "question": "Siapa yang berisiko terkena penyakit parah?",
      "answer":
          "Sementara kita masih mempelajari bagaimana COVID-2019 mempengaruhi orang, orang tua dan orang dengan kondisi medis yang sudah ada sebelumnya (seperti tekanan darah tinggi, penyakit jantung, penyakit paru-paru, kanker atau diabetes) tampaknya lebih sering mengembangkan penyakit serius daripada yang lain."
    },
    {
      "question":
          "Haruskah saya memakai masker untuk melindungi diri saya sendiri?",
      "answer":
          "Gunakan masker hanya jika Anda sakit dengan gejala COVID-19 (terutama batuk) atau merawat seseorang yang mungkin mengidap COVID-19. Masker wajah sekali pakai hanya dapat digunakan sekali. Jika Anda tidak sakit atau merawat seseorang yang sakit maka Anda membuang-buang masker. Ada kekurangan masker di seluruh dunia, jadi WHO mendesak orang untuk menggunakan masker dengan bijak.\nWHO menyarankan penggunaan masker medis secara rasional untuk menghindari pemborosan sumber daya yang berharga dan penyalahgunaan masker\nCara paling efektif untuk melindungi diri sendiri dan orang lain pencegahan COVID-19 adalah dengan sering membersihkan tangan, menutupi batuk dengan siku atau tisu dan menjaga jarak minimal 1 meter (3 kaki) dari orang yang batuk atau bersin."
    },
    {
      "question":
